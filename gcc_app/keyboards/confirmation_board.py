...
def create_confirmation_board() -> InlineKeyboardMarkup:
    ...
    confirmation_kb = InlineKeyboardMarkup(row_width=2).add(confirmation, refusal)
...
def create_confirmation_button() -> ReplyKeyboardMarkup:
    ...
    confirmation_kb = ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True)
